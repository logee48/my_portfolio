...
function App() {
  ...
  return (
    ...
    <div class="headertags">
      ...
      <div id="header1"><a href="#pro">Project</a></div>
      <div id="header1">Contact</div>
    </div>
    <div class='header2'>
      <div class='nameplace'>
    <h1 id='fname'>Logeshwaran</h1>
    <h1 id='sname'>Elumalai</h1>
    </div>
    <div id='pimage'>
    <img src={charimg} id='pimage' alt='noone'></img></div>
    <h2>currently sophomore uni student<br></br>living in chennai</h2>
    </div>
    </div>
    <div class='new1'>
    ...
    <div class='new2' id='pro'>
      ...
      <div class='projectsection'>
        <div class='project1' onClick={fun1}>
          <h3>Project1 title</h3>
          <p>small des frequently occur that pleasures have to be repudiated and annoyances accepted. The wise man therefore always holds in these matters to this principle of selection: he rejects </p>
        </div>
        <div class='project2' onClick={fun2}>
          <h3>Project2 title</h3>
          <p>small des frequently occur that pleasures have to be repudiated and annoyances accepted. The wise man therefore always holds in these matters to this principle of selection: he rejects </p>
        </div>
        <div class='project3' onClick={fun3}>
          <h3>Project3 title</h3>
          <p>small des frequently occur that pleasures have to be repudiated and annoyances accepted. The wise man therefore always holds in these matters to this principle of selection: he rejects </p>
        </div>
        <div class='project4' onClick={fun4}>
          <h3>Project1 title</h3>
          <p>small des frequently occur that pleasures have to be repudiated and annoyances accepted. The wise man therefore always holds in these matters to this principle of selection: he rejects </p>
        </div>
        <div class='project5' onClick={fun5}>
          <h3>Project2 title</h3>
          <p>small des frequently occur that pleasures have to be repudiated and annoyances accepted. The wise man therefore always holds in these matters to this principle of selection: he rejects </p>
        </div>
        <div class='project6' onClick={fun6}>
          <h3>Project3 title</h3>
          <p>small des frequently occur that pleasures have to be repudiated and annoyances accepted. The wise man therefore always holds in these matters to this principle of selection: he rejects </p>
        </div>
      </div>
      ...
      <div class='projectdet1'>
          ...
          <div class='projectdetdes'>small des frequently occur that pleasures have to be repudiated and annoyances accepted. The wise man therefore always holds in these matters to this principle of selection: he rejects</div>
      </div></div>
